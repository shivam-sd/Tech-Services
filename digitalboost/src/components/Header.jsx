...
const Header = () => {
  ...
  return (
    <div className="w-full bg-gray-800 text-white">
      ...
      <div className="w-full bg-[#5C7285] p-2 flex items-center justify-between lg:p-3 lg:pl-8 lg:pr-8">
        ...
        <div className="second flex items-center justify-center">
          <h1 className="text-2xl font-bold text-stone-300">Digital Boost</h1>
        </div>
      ...
      <div
        className={`w-full bg-gray-600 p-2 transition-all duration-500 ease-in-out ${
          isOpen
